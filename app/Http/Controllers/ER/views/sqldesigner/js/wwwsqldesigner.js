SQL.Designer = function() {
    ...
    var obj = jQuery('<defs>' +
      ...
      '<path d="M0,0 L0,6 L9,3" fill="#f00"></path>' +
      '</marker>' +
      '<marker id="arrow2" markerWidth="10" markerHeight="10" refX="9" refY="3" orient="auto" markerUnits="strokeWidth">' +
      '<path d="M0,3 L9,0 L9,6" fill="#f00"></path>' +
      '</marker>' +
      '</defs>');
    this.dom.svg.appendChild(obj.get(0));
    jQuery(this.dom.svg).html(jQuery(this.dom.svg).html());
